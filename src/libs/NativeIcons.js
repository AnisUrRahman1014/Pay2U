...
const createIcon =
  ...
  ({ onPress, size, color, disabled, style }) =>
    (
      <TouchableOpacity
        style={[styles(size).wrapper, style]}
        onPress={onPress}
        disabled={disabled}
      >
...
const AppIcons = {
  ...
  HomeIconActive: createIcon(Ionicons, "home"),
  HomeIconInActive: createIcon(Ionicons, "home-outline"),
  FriendsIconActive: createIcon(FontAwesome5, "user-friends"),
  FriendsIconInActive: createIcon(Feather, "users"),
